		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "com.app",
									"targetURL": "#gitsamplegitsample-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"gitsamplegitsample-display": {
								"semanticObject": "gitsamplegitsample",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=gitsample.gitsample",
									"url": sap.ui.require.toUrl("gitsample/gitsample")
								}
							}
						}
					}
